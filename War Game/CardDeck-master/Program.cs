        ...
        static void War(Deck deck)
        {
            ...
            while (playerDeck.NumCards > 0 && computerDeck.NumCards > 0)
            {
                ...
                if (pCard == cCard)
                {
                    ...
                    {
                        Console.WriteLine($"{pCard} and {cCard} are the same. You know what that means...");
                        ...
                        if (pCard2 < cCard2)
                        {
                            Console.WriteLine($"{cCard2} is bigger than {pCard2}. You lose the war!");
                            computerDeck.AddCard(pCard);
                            computerDeck.AddCard(cCard);
                        ...
                        {
                            Console.WriteLine($"{pCard2} is bigger than {cCard2}. You win the war!");
                            playerDeck.AddCard(pCard);
                            playerDeck.AddCard(cCard);
            ...
            {
                Console.WriteLine("You win! Yay :D");
            }
        }
    }
}