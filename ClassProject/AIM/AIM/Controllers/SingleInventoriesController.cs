...
{
    public class SingleInventoriesController : Controller
    {
        private readonly ProjectDatabaseDbContext _context;

        public SingleInventoriesController(ProjectDatabaseDbContext context)
        {
            _context = context;
        }

        // GET: SingleInventories
        public async Task<IActionResult> Index()
        {
            return View(await _context.SingleInventory.ToListAsync());
        }

        // GET: SingleInventories/Details/5
        ...
        // GET: SingleInventories/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: SingleInventories/Create
        ...
        // GET: SingleInventories/Delete/5
        ...
        // POST: SingleInventories/Delete/5
